...
class NoneTierCus(Customer):
    def __init__(self, name: str):
        super().__init__(name, "none")


class SilverTierCus(Customer):
    def __init__(self, name: str):
...
class PlatinumTierCus(Customer):
    def __init__(self, name: str):
...
CUSTOMER_CLASSES = {
    "none": NoneTierCus,
    "silver": SilverTierCus,
    "gold": GoldTierCus,
    "platinum": PlatinumTierCus,
}
